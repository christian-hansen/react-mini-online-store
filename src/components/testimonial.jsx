...
class Testimonial extends Component {
    ...
    render() { 
        return (
<section id="testimonials" className="bg-light d-flex flex-column justify-content-center align-items-center">
            <div className="row">
              <div>"</div>
            </div>
            <Carousel className='text-dark padding-large' fade>
              ...
              <div class="review-item col-md-10">
                    ...
                    <blockquote>“Really beautiful themed cups that make me enjoy my morning coffee even more.”</blockquote>
                    <div class="rating">
                    ...
                    <div class="author-detail">
                      <div class="name text-dark text-uppercase pt-2">Elena Small</div>
                    </div>
                </div>
                </div>
              </Carousel.Item>
